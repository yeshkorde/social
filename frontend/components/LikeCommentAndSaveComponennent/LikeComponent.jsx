    ...
    <div className="flex justify-center items-center gap-2 p-2 rounded-full cursor-pointer group">
      {!isLiked ? (
        <motion.svg
          ...
          onClick={handleLike}
          aria-label="Like"
          className="dark:fill-[#697986] fill-[#4c555d] group-hover:fill-[#ff0072] unlike"
          height="20"
          role="img"
          viewBox="0 0 24 24"
          width="20"
        ...
        <motion.svg
          ...
          aria-label="Unlike"
          onClick={handleLike}
          className="x1lliihq x1n2onr6 xxk16z8 fill-[#ff0072] like"
          height="20"
          role="img"
          viewBox="0 0 48 48"
          width="20"
      ...
      <p className="text-[#697986] group-hover:text-[#ff0072] ibm-plex-sans-medium">
        {like}
      </p>
    </div>
  );
