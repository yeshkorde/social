    ...
    <div className="h-full w-full flex flex-col justify-center items-center gap-6 px-40 py-4  ">
      ...
      <div className="flex justify-between items-center w-full px-20">
        <div className="flex flex-col gap-2 justify-start items-start">
          ...
          <div>
          <p className="ibm-plex-sans-semibold text-[12px]">Likes {post.likes.length}</p>
          <p className="text-[16px] ibm-plex-sans-semibold "><span className="text-[14px]">{post.user.userName} </span>{post.caption}</p>
          <p className=" ibm-plex-sans-semibold text-[12px]">{post.discription}</p>
          <p className=" dark:text-[#c4c4c4a1] text-[#171717a1] ibm-plex-sans-semibold text-[12px]">View All {post.comments.length} Comments</p>
          </div>
        </div>
        <svg
          aria-label="Save"
