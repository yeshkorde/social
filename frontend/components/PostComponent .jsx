          ...
          <UserHoverCard
              ...
              <Link
                to={
                  userData._id === post.userId._id
                    ? "/profile"
                    : `userProfile?id=${post.userId._id}`
                }
              >
                <div
                  ref={triggerRef}
                  className="h-16 w-16 dark:border-[#2b2b2b] shadow-[1px_1px_30px] shadow-[#dddddd]  dark:bg-black dark:border dark:shadow-[#000] rounded-full p-1"
                >
                  <img
            ...
            content={
              <div className="w-[400px] h-80">
                <div className="flex bg-white rounded-xl dark:bg-black dark:shadow-[#000] shadow-2xl p-4 shadow-[#c0c0c0]">
                  ...
                  <div className="flex flex-col justify-center   ml-4">
                    <p className="text-md ibm-plex-sans-semibold ">
                      {post.userId.userName}
                    </p>
                    <p className="text-[12px] text-[#303030] ibm-plex-sans-semibold dark:text-[#b3b3b3]">
                      {post.userId.name}
                    </p>
                    <p className="text-[10px] text-[#303030] ibm-plex-sans-semibold dark:text-[#b3b3b3]">
                ...
                <div className="columns-3 gap-4 space-y-4 h-[60%] mt-4">
                  {post.userId.postes.slice(0, 3).map((post, index) => (
                    <div
                      key={index}
                      className="break-inside-avoid h-full overflow-hidden rounded-xl shadow-md "
                    >
                      {post?.media?.length > 0 &&
                      post.media[0].type !== "image" ? (
                        <video className="w-full h-auto object-cover rounded-lg"
        ...
        <div className="flex flex-col gap-2 justify-start items-start w-full">
          ...
          <div>
            <p className="text-[16px] ibm-plex-sans-semibold ">
              <span className="text-[14px]">{post.userId.userName} </span>
              {post.caption}
            </p>
