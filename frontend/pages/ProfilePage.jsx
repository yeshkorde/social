  ...
  const handleProfileImageRemove = async () => {
    try {
      ...
      const res = await axios.post(
        ...
        }/api/user/UpdateProfileImage?q=remove`,
        null,
        {
  ...
  const handleProfileImageChange = async (e) => {
    try {
      ...
      const res = await axios.post(
        `${
          import.meta.env.VITE_SERVER_BASE_URL
        }/api/user/UpdateProfileImage?q=update`,
        formData,
        {
          headers: {
          ...
          <div className="px-8 py-4 h-1/2 flex flex-col justify-center gap-4 items-center">
            {isLoding ? (
              ...
              <div className="w-full h-full items-center  flex flex-col gap-4 pt-4">
                ...
                <button
                  className="py-2 px-6 w-full rounded-xl border ibm-plex-sans-semibold "
